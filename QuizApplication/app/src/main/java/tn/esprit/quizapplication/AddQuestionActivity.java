...
public class AddQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterItems = new ArrayAdapter<String>(AddQuestionActivity.this,R.layout.dropdown_item,levels);
        autoCompleteLevel.setAdapter(adapterItems);

        adapterItems = new ArrayAdapter<String>(AddQuestionActivity.this,R.layout.dropdown_item,topics);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(question.getText().toString().equals("") || option1.getText().toString().equals("") || option2.getText().toString().equals("")
                    ...
                    QuestionList q= new QuestionList(question.getText().toString(),option1.getText().toString(),option2.getText().toString()
                            ,option3.getText().toString(),option4.getText().toString(),answer,level,topic,"");
                    myDB.questionListDAO().insertQuestion(q);
                    Toast.makeText(getApplicationContext(),"Question added!",Toast.LENGTH_SHORT).show();
                    Intent intent= new Intent(AddQuestionActivity.this,ListQuestionActivity.class);
